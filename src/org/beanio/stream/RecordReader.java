...
public interface RecordReader {
	...
	/**
	 * Reads a single record from the underlying stream.  The type of object
	 * returned depends will depend on the type of stream.
	 * @param in Stream to read from
	 * @return record value, or null if the end of the stream was reached.
	...
	/**
	 * Returns the line number of the last record from the input stream.  If a
	...
	/**
	 * Returns the raw record text of the last record read.
