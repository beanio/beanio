...
/**
 * This reader reader factory is used to create and configure a <tt>CsvReaderFactory</tt>.
 * 
 * @author Kevin Seim
 * @since 1.0
 */
public class CsvReaderFactory implements RecordReaderFactory {
	...
	public RecordReader createReader(Reader in) {
		...
		return new CsvReader(in, delimiter, quote, escape, multilineEnabled,
	...
	/**
     * Sets the escape character.  Quotation marks can be escaped within quoted values
     * using the escape character.  For example, using the default escape character,
     * '"Hello ""friend"""' is parsed into 'Hello "friend"'.
    ...
    /**
     * Returns the escape character.  Quotation marks can be escaped within quoted values
     * using the escape character.  For example, using the default escape character,
     * '"Hello ""friend"""' is parsed into 'Hello "friend"'.
	 ...
	 * @param multilineEnabled set to true <tt>true</tt> to allow records
	...
	/**
	 * Returns whether to ignore unquoted whitespace.  Returns <tt>false</tt>
	 * by default which causes the following record cause an exception:
	 * <pre>
	 * "Field1", "Field2"
	 *          ^
	 ...
	 * @param whitespaceAllowed set to <tt>true</tt> to ignore unquoted whitespace
	 */
	...
	/**
	 * Returns whether quotes are allowed to appear in an unquoted field.  Set
	 * to <tt>false</tt> by default which will cause the following record to
	 * throw an exception:
	 * <pre>
	 ...
	 * @param unquotedQuotesAllowed set to <tt>true</tt> if quotes may appear
