...
/**
 * A <tt>FixedLengthStreamDefinition</tt> is used to parse and format streams
 * that use a fixed length record format.
 * 
 * @author Kevin Seim
 * @since 1.0
 */
public class FixedLengthStreamDefinition extends StreamDefinition {

	/**
	 * Constructs a new <tt>FixedLengthStreamDefinition</tt>.
	 */
